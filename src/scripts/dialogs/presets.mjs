...
export class PresetDialog extends FormApplication {
  ...
  activateListeners(html) {
    ...
    html[0]
      .querySelectorAll(`#${MODULE.ID}-presets-list li`)
      .forEach((elemPreset) => {
        // INFO
        elemPreset
          .querySelector('button[data-action="info"]')
          .addEventListener("click", presetInfo);
        // UPDATE
        elemPreset
          .querySelector('button[data-action="update"]')
          .addEventListener("click", updatePreset);
        // Delete
        elemPreset
        ...
        // ACTIVATE
        elemPreset
          .querySelector('button[data-action="activate"]')
          .addEventListener("click", activatePreset);
      });
          ...
          yes: (elemDialog) => {
            ...
            MODULE.setting(
              ...
              mergeObject(
                ...
                {
                  [presetKey]: {
                    name: elemDialog[0].querySelector(
                      `input[name="${MODULE.ID}-preset-title"]`,
                    )?.value,
              ...
              html[0]
                .querySelector(
                  `#${MODULE.ID}-presets-list li:last-of-type button[data-action="info"]`,
                )
                .addEventListener("click", presetInfo);
              ...
              html[0]
                .querySelector(
                  `#${MODULE.ID}-presets-list li:last-of-type button[data-action="update"]`,
                )
                .addEventListener("click", updatePreset);
              ...
              html[0]
                .querySelector(
                  `#${MODULE.ID}-presets-list li:last-of-type button[data-action="delete"]`,
                )
                .addEventListener("click", deletePreset);
              ...
              html[0]
                .querySelector(
                  `#${MODULE.ID}-presets-list li:last-of-type button[data-action="activate"]`,
                )
                .addEventListener("click", activatePreset);
              return true;
            });
